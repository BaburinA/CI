        ...
        <div class="row">
            <div class="panel-title col-sm-12">
                ...
                <div id="options-content" class="col-sm-10 text-right">
                    ...
                    <a class="btn btn-danger btn-sm" href="/admin/menu/delete_menu" onclick="CMSApi.deleteFunction('deleteCheckbox', '/admin/menu/menu_list/<?=$menu_id?>'); return false;" title="Удалить" class="add-anchor btn" id="deleteCheckbox" disabled="disabled">
                        <i class="fa fa-trash"></i> Удалить
                    </a>
                    <a class="btn btn-info btn-sm" href="/admin/menu/menu_list_sortable/<?=$menu_id?>" title="Сортировать меню" class="add-anchor btn">
        ...
        <div class="frame_table">
            <div id="category">
                ...
                <div class="body_category frame_level">
                    <div class="sortable save_positions" data-url="/admin/menu/save_positions/">
                        <?=$menu_list?>
                    </div>
                </div>
            </div>
