...
class Forms extends MX_Controller {
	...
	function get($id)
	{
        ...
        $this->load->view("themes/site/forms/forms_get_" . $id . ".tpl", $data);
	}
    ...
    function _final($id)
    {
        ...
        if(isset($data['forms_parser']))
        {
            ...
            $this->parser->parse("themes/site/block_parse.tpl", $data);
        }
        else{
            $this->load->view("themes/site/forms/forms_final.tpl", $data);
        }
    }
    ...
    function show_error($message = FALSE){
        if($message){
            ...
            $this->load->view("themes/site/forms/forms_show_error.tpl", $data);
        }
        else{
            return TRUE;
        }
