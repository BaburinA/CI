        ...
        <div class="row">
            <div class="panel-title col-lg-12">
                ...
                <div id="options-content" class="col-lg-10 text-right">
                    <a class="btn btn-success btn-sm" href="/admin/menu/add" title="Создать страницу" class="add-anchor btn">
                    ...
                    <td class="col-lg-2 text-right">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="/admin/edit_menu/{id}" title="Редактировать">
                                        <i class="fa fa-pencil"></i> Редактировать</a>
                                </li>
                                <li>
                                    <a href="/admin/delete_menu/{id}" title="Удалить" class="delete-row">
