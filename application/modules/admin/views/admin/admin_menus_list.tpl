        ...
        <div class="row">
            <div class="panel-title col-sm-12">
                ...
                <div id="options-content" class="col-sm-10 text-right">
                    <a class="btn btn-danger btn-sm" href="/admin/menu/delete_menus" onclick="CMSApi.deleteFunction('deleteCheckbox', '/admin/menu/menus_list'); return false;" title="Удалить" class="add-anchor btn" id="deleteCheckbox" disabled="disabled">
                        <i class="fa user-times"></i>
                        Удалить
                    </a>
                    <a class="btn btn-success btn-sm" href="/admin/menu/add_menus" title="Создать меню" class="add-anchor btn">
